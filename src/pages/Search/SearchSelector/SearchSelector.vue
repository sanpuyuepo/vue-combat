  ...
  <div class="clearfix selector">
    <div class="type-wrap logo">
      ...
      <div class="value logos">
        <ul class="logo-list">
          <li v-for="trademark in trademarkList" :key="trademark.tmId" @click="sendTrademarkInfo(trademark)">
            {{ trademark.tmName }}
          </li>
        </ul>
      </div>
