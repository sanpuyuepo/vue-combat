  ...
  <div class="trade-container">
    ...
    <div class="money clearFix">
      <ul>
        ...
        <li>
          <b>返现：</b>
          <span>{{ orderList.activityReduceAmount }}</span>
        </li>
        <li>
          <b>运费：</b>
          <span>0.00</span>
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{ deliveryAddress.fullAddress }}</span>
        收货人：<span>{{ deliveryAddress.consignee }}</span>
        <span>{{ deliveryAddress.phoneNum }}</span>
      </div>
    </div>
...
export default {
  ...
  computed: {
    ...mapGetters(["addressList", "orderList"]),
    // 寄送地址
    deliveryAddress() {
  ...
  methods: {
    ...
    async submit() {
      const { tradeNo } = this.orderList;
      const data = {
        consignee: this.deliveryAddress.consignee,
        consigneeTel: this.deliveryAddress.phoneNum,
        deliveryAddress: this.deliveryAddress.fullAddress,
        paymentWay: "ONLINE",
